...
namespace tests {
namespace test_gl {
class MultithreadedShadowMappingSceneTest : public BaseShadowMappingSceneTest, public framework::GLTest
{
  public:
    MultithreadedShadowMappingSceneTest(bool benchmarkMode, float benchmarkTime);
