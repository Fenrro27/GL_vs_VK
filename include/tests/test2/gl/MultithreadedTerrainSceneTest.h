...
namespace tests {
namespace test_gl {
class MultithreadedTerrainSceneTest : public BaseTerrainSceneTest, public framework::GLTest
{
  public:
    MultithreadedTerrainSceneTest(bool benchmarkMode, float benchmarkTime);
